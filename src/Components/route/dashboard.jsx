        ...
        <section className=" h-[77vh]  w-full flex items-center justify-center  ">
          <div className="w-[100%]  lg:h-5/6  h-[100%] flex space-x-4 lg:justify-start justify-center ">
            <div className="w-1/5   space-y-4  items-center  py-4  rounded-sm  shadow-md   flex-col hidden lg:flex ">
              <div
                className="w-4/5 h-24  rounded  items-center -center flex flex-col py-2"
                style={{
              ...
              <div
                className="w-4/5 h-24  bg-white rounded  items-center justify-center flex flex-col"
                style={{
                  boxShadow: "rgba(149, 157, 165, 0.2) 0px 8px 24px",
                }}
              >
              ...
              <div
                className="w-4/5 h-24  rounded  items-center justify-center flex flex-col"
                style={{
                  boxShadow: "rgba(149, 157, 165, 0.2) 0px 8px 24px",
                }}
              >
            ...
            <div
              className="lg:w-3/4 w-full  space-y-4 h-5/6  flex flex-col "
              style={{
                boxShadow: "rgba(149, 157, 165, 0.2) 0px 8px 24px",
              }}
            >
              <div className="h-[25%] flex space-x-4 py-4  items-center justify-center text-center ">
                <div
                  className="w-4/5 h-24  rounded  items-center justify-center flex flex-col py-2"
                  style={{
                    boxShadow: "rgba(149, 157, 165, 0.2) 0px 8px 24px",
                  }}
                >
